...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sasidebar" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ $current_route == 'Sdashboard' ? 'active' : '' }}">
    ...
    <!-- Nav Item - Account -->
    <li class="nav-item {{ $current_route == 'statistician.account' ? 'active' : '' }}">
        <a href="{{ route('statistician.account') }}" class="nav-link">
    ...
    <li class="nav-item">
        ...
        <div id="collapseThesisCheck" class="collapse" aria-labelledby="headingThesisCheck" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="{{ route('statistician.route1.index') }}">Routing Form 1</a>
            <a class="collapse-item" href="{{ route('statistician.route2.index') }}">Routing Form 2</a>
            </div>
        </div>
    </li>
</ul>
