...
function openModal(userId) {
    ...
    $('#disapproveModal').modal('hide'); // Hide the modal after submission
            ...
            document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
                ...
                deleteForm.action = '/graduateschool/verifyusers/' + userIdToDelete;
                deleteForm.submit();
            });
...
// Adjust the disapprove button in the verification modal to call openDisapproveModal without parameters
// since selectedUserId is already set.
