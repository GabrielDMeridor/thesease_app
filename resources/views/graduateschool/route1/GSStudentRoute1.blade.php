                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($appointment->signed_routing_form_1)
                            <input type="text" 
                                   ...
                                   style="cursor: pointer;">
                        @else
                            <input type="text" class="form-control" readonly placeholder="File not yet uploaded">
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @if($appointment->proposal_video_presentation)
                            <input type="text" 
                                   ...
                                   style="cursor: pointer;">
                        @else
                            <input type="text" class="form-control" readonly placeholder="Student did not upload the file yet.">
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    @if ($appointment->submission_files_link)
                        <p>
                            ...
                            <i class="fa-solid fa-link"></i> {{ $appointment->submission_files_link }}
                            </a>
                        </p>
                    @else
                    ...
                    @if ($appointment->submission_files_approval === 'pending')
                        <form action="{{ route('graduateschool.approveSubmissionFiles', $student->id) }}" method="POST" class="mt-3">
                            @csrf
    ...
    <div class="card shadow mb-4">
        <div class="card-body d-flex flex-column flex-md-row align-items-center">
            ...
            <div class="qr-code-section text-center mb-4 mb-md-0 d-flex flex-column align-items-center">
                <img src="{{ asset('img/cdaic_qr.png') }}" alt="QR Code for CDAIC Service Request" class="img-thumbnail rounded" style="width: 120px; border: 2px solid #ddd;">
                <p class="mt-2 text-muted" style="font-size: 0.9rem;">Scan to access the Service Request Form</p>
            </div>
            ...
            <div class="instructions-section ml-md-4">
                ...
                <p>Afterward, please send your manuscript to: 
            ...
            <div class="table-responsive">
                <table class="table table-bordered custom-table">
                    ...
                    <tbody>
                        ...
                        <!-- Documents with External Links and Upload Status -->
                        @php
                            $documents = [
