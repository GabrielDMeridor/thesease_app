...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sasidebar" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ $current_route == 'TDPdashboard' ? 'active' : '' }}">
        <a href="{{ route('TDPdashboard') }}" class="nav-link">
    ...
    <!-- Nav Item - Account -->
    <li class="nav-item {{ $current_route == 'tdprofessor.account' ? 'active' : '' }}">
        <a href="{{ route('tdprofessor.account') }}" class="nav-link">
        ...
        <li class="nav-item {{ $current_route == 'panel.monitoring' ? 'active' : '' }}">
        <a href="{{ route('panel.monitoring') }}" class="nav-link">
            <i class="fas fa-fw fa-calendar"></i>
    ...
    <li class="nav-item">
        ...
        <div id="collapseThesisCheck" class="collapse" aria-labelledby="headingThesisCheck" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="{{ route('tdprofessor.route1') }}">Routing Form 1</a>
            <a class="collapse-item" href="{{ route('tdprofessor.route2') }}">Routing Form 2</a>
            </div>
        </div>
    </li>
