...
class ACalendarController extends Controller
{
    public function index()
    {
        // Ensure user is a SuperAdmin before accessing this page
        if (!auth()->check() || auth()->user()->account_type !== User::Admin) {
            return redirect()->route('getSALogin')->with('error', 'You must be logged in as a Admin to access this page.');
        }
        ...
        return view('admin.calendar.Acalendar', $data);
    }
