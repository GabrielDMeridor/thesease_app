...
class AVerifyUserController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.verify-users.Averify', [
            'title' => 'Verify Users',
            'users' => $users,
        ]);
    }
    ...
    public function verifyUsers(Request $request)
    {
        ...
        return redirect()->route('admin.verify-users.index')->with('success', 'Users updated and emails sent successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.verify-users.index')->with('success', 'User deleted successfully.');
    }
