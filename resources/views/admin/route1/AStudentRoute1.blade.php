   ...
   <div class="card-body">
            ...
            <div class="container-fluid">
               <div class="card shadow mb-4">
                  <div class="card-body">
                     ...
                     <form action="{{ route('admin.approveCommunityExtension', $student->id) }}" method="POST">
                        @csrf
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>Current status of the student's submissions for the Ethics Review:</p>
            ...
            <div class="table-responsive">
                <table class="table table-bordered custom-table">
                    ...
                    <tbody>
                        ...
                        <!-- Other documents with download links and upload statuses -->
                        @php
                            $documents = [
