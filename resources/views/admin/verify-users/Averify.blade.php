...
<div class="row">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.verify-users.index') }}" id="filterForm" class="mb-4">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm">
        ...
        <div class="user-management-section">
            ...
            <form id="verification-form" method="POST" action="{{ route('admin.verify-users.verify') }}">
                @csrf
...
<div class="modal fade" id="disapproveModal" tabindex="-1" role="dialog" aria-labelledby="disapproveModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="disapproveForm" method="POST" action="{{ route('admin.verify-users.disapprove') }}">
                    @csrf
...
function openModal(userId) {
    ...
    $('#disapproveModal').modal('hide'); // Hide the modal after submission
            ...
            document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
                ...
                deleteForm.action = '/admin/verifyusers/' + userIdToDelete;
                deleteForm.submit();
            });
