...
class TDPAccountController extends Controller
{
    public function TDPaccount()
    {
        ...
        return view('tdprofessor.account.TDPAccount', $data);
    }

    // Update Profile// Update Profile using AJAX
