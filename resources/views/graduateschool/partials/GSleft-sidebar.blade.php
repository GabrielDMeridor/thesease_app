...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sasidebar" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ $current_route == 'GSdashboard' ? 'active' : '' }}">
        <a href="{{ route('GSdashboard') }}" class="nav-link">
    ...
    <!-- Nav Item - Account -->
    <li class="nav-item {{ $current_route == 'graduateschool.account' ? 'active' : '' }}">
        <a href="{{ route('graduateschool.account') }}" class="nav-link">
     ...
     <li class="nav-item {{ $current_route == 'graduateschool.verify-users.index' ? 'active' : '' }}">
        <a href="{{ route('graduateschool.verify-users.index') }}" class="nav-link">
    ...
    <li class="nav-item {{ $current_route == 'graduateschool.calendar' ? 'active' : '' }}">
        <a href="{{ route('graduateschool.calendar') }}" class="nav-link">
    ...
    <li class="nav-item">
        ...
        <div id="collapseThesisCheck" class="collapse" aria-labelledby="headingThesisCheck" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="{{ route('graduateschool.route1') }}">Routing Form 1</a>
            <a class="collapse-item" href="{{ route('graduateschool.route2') }}">Routing Form 2</a>
            </div>
        </div>
    </li>

    <!-- Nav Item - Archive -->
    <li class="nav-item {{ $current_route == 'graduateschool.archive' ? 'active' : '' }}">
        <a href="{{ route('graduateschool.archive') }}" class="nav-link">
