...
class SARoute2Controller extends Controller
{
    public function show(Request $request)
    {
        ...
        return view('superadmin.route2.SAroute2', compact('students', 'title'));
    }
    ...
    public function showRoutingForm($studentId)
    {
        ...
        return view('superadmin.route2.SAStudentRoute2', compact('student', 'appointment', 'title', 'isDrPH', 
        'final_ovpri_link','totalSteps'));
    }
}
