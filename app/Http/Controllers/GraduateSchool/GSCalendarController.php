...
class GSCalendarController extends Controller
{
    public function index()
    {
        // Ensure user is a SuperAdmin before accessing this page
        if (!auth()->check() || auth()->user()->account_type !== User::GraduateSchool) {
            return redirect()->route('getSALogin')->with('error', 'You must be logged in as a Graduate School to access this page.');
        }
        ...
        return view('graduateschool.calendar.GScalendar', $data);
    }
    public function storeSchedule(Request $request)
    {
        ...
        return redirect()->route('graduateschool.calendar')->with('success', 'Schedule successfully created');
    }
