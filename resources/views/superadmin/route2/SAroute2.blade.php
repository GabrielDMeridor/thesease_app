...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('superadmin.route2') }}" method="GET">
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
            ...
            @forelse($students as $student)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('superadmin.showRoutingForm2', $student->id) }}" class="btn btn-primary"><i class="fa-solid fa-file"></i> View Routing Form 2</a>
                    </td>
                </tr>
            @empty
                <tr>
