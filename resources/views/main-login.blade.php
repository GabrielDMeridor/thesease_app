...
<body class="bg-gradient-primary loginbg">
                        ...
                        <!-- Nested Row within Card Body -->
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr class="lineborder">
                                    <div class="text-center">
                                    <a class="btn btn-primary btn-user btn-block btn-createacc" href="{{ route('getRegister') }}">Create an Account</a>
                                    </div>
