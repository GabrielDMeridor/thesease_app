...
class GSVerifyUserController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('graduateschool.verify-users.GSverify', [
            'title' => 'Verify Users',
            'users' => $users,
        ]);
    }
    ...
    public function verifyUsers(Request $request)
    {
        ...
        return redirect()->route('graduateschool.verify-users.index')->with('success', 'Users updated and emails sent successfully.');
    }
    ...
    public function updateVerificationStatus(Request $request, User $user)
    {
        ...
        return redirect()->route('graduateschool.verify-users.index')->with('success', 'User status updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('graduateschool.verify-users.index')->with('success', 'User deleted successfully.');
    }
    ...
    public function disapprove(Request $request)
    {
        ...
        return redirect()->route('graduateschool.verify-users.index')->with('success', 'User disapproved and notified successfully.');
    }
